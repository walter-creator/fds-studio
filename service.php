                  ...
                  <div class="col-xl-3 col-lg-3 col-md-3 col-sm-3 col logo_section">
                     <div class="full">
                        <div class="center-desk">
                           <div class="logo">
                              <a href="index.html"><span class="orang">FDS</span> studio.</a>
                           </div>
                        </div>
                     </div>
                  </div>
      ...
      <div class="plane">
         <div class="container">
            <div class="row">
               <div class="col-sm-12">
                  <div class="titlepage">
                     <span>faites appelle a <i class="orang">Foto Des Stars </i>pour immortaliser vos evennements. Que ce soit marriage, anniversaire, soutenance, conferance, reunion, dote, ou autres ... </span>
                  </div>
               </div>
            </div>
            <div class="row">
